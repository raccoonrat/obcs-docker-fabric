...
# install develpoment tools for OEL
yum groupinstall -y "development tools"

# install common tools
COMMON_TOOLS="git net-tools netcat-openbsd autoconf automake libtool curl make g++ unzip build-essential openssl perl bash wget"
